...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("border-b border-emerald-600 last:border-b-0", className)}
      {...props}
    />
  );
}
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 cursor-pointer items-start justify-between gap-4 rounded-md py-4 text-left transition-all outline-none hover:text-emerald-500 focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:-rotate-90",
          className,
        )}
        {...props}
      >
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down text-light overflow-hidden"
      {...props}
    >
