...
function Calendar(
  ...
  const _dayButtonClassName = cn(
    ...
    "size-8 p-0 hover:bg-emerald-100  hover:!outline-emerald-500 font-normal aria-selected:outline-[0.1em] aria-selected:outline-emerald-500 aria-selected:bg-emerald-100",
  ...
  const _selectedClassName = cn(
    "[&>button]:bg-emerald-100 text-emerald-700 z-10 outline-[0.2em] outline-emerald-500  rounded-[0.75em] [&>button]:text-primary-foreground [&>button]:hover:bg-primary [&>button]:hover:text-primary-foreground",
    props.selectedClassName,
  );
  const _todayClassName = cn(
    "[&>button]:!bg-emerald-200 [&>button]:text-emerald-700",
